  ...
  config = function()
    ...
    vim.api.nvim_create_autocmd("LspAttach", {
      ...
      callback = function(event)
        ...
        -- Nvim 0.12+ provides default LSP mappings: grn (rename), gra (code action),
        -- grr (references), gri (implementation), grt (type definition), grx (code lens).
        -- We keep telescope-powered UI under <leader> for richer navigation.

        -- Jump to the definition of the word under your cursor. To jump back, press <C-t>.
        map("gd", require("telescope.builtin").lsp_definitions, "[G]oto [D]efinition")

        -- Telescope UI alternatives for the default gr* mappings
        ...
        map("<leader>gt", require("telescope.builtin").lsp_type_definitions, "[G]oto [T]ype Definition (Telescope)")
